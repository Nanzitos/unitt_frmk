    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal FiltroForm" id="FormFiltros" role="form" style="margin-top:20px;" method="GET" action="<?php echo e(url('usuarios')); ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="id_grupo" placeholder="Grupo" class="form-control">
                  ...
                  <?php foreach(App\GruposUsuarios::all() AS $grupo): ?>
