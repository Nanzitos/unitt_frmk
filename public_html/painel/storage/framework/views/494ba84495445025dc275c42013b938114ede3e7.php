<div class="header navbar">
  ...
  <ul class="nav navbar-nav hidden-xs" style="width: 100%">
    ...
    <?php if(isset($ConfigFile['filtros']) && $ConfigFile['filtros']): ?>
    <li class="searchbox">
    ...
    <li class="navbar-form search-form hide my_last_li">
      <div class="box_white">
        ...
        <?php foreach($ConfigFile['filtros'] AS $filtro): ?>
            <?php echo e(FormHelper::getInput($filtro, null, 3)); ?>
  ...
  <ul class="nav navbar-nav navbar-right hidden-xs">
    ...
    <li style="margin-top: -55px;">
      <a href="javascript:;" class="ripple" data-toggle="dropdown">
        <img src="/assets/profiles/<?php echo e($Usuario->id); ?>.jpg" class="header-avatar img-circle" alt="user" title="user" onerror="this.src='../public/assets/images/man.png'; this.title='Imagem não disponível.'" title="Imagem não disponível.">
        <span><?php echo e($Usuario->nome.' '.$Usuario->sobrenome); ?></span>
        <span class="caret"></span>
      </a>
      <ul class="dropdown-menu">
        <li>
          <a href="<?php echo e(url('perfil/')); ?>">Meu perfil</a>
        </li>
