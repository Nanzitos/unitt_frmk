    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" id="FormCampanhasBanners" role="form" style="margin-top:20px;" method="GET" action="{{ url('get-campanhas-banners') }}">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="id_parceiro" placeholder="Selecione um parceiro" class="form-control Parceiro">
