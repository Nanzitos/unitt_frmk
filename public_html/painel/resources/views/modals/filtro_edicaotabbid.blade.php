    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal FiltroForm" id="FormFiltros" role="form" style="margin-top:20px;" method="GET" action="{{ url('/edicao-tabbid') }}">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="status" placeholder="" id="satausTabBids" class="form-control">
