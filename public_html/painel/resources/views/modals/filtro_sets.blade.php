    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Filtrar Sets</h4>
        </div>
        <div class="modal-body">
          <p>Selecione os filtros que deseja aplicar.</p>
          <form class="form-horizontal FiltroForm" id="FormBuscaPedidos" role="form" style="margin-top:20px;" method="GET" action="{{ url('uploaddebanners') }}">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <option value='0' <?php echo (isset($_GET['id_da']) && $_GET['id_da'] && $_GET['id_da'] == '0')?'selected="selected"':'';?>>Usuários do MKT</option>
                @foreach(App\Usuarios::where('id_grupo','=','9')->get() AS $DA)
