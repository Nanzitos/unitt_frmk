    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Filtrar Nfes</h4>
        </div>
        <div class="modal-body">
          <p>Selecione os filtros que deseja aplicar a lista de nfes.</p>
          <form class="form-horizontal FiltroForm" id="FormFiltros" role="form" style="margin-top:20px;" method="GET" action="{{ url('compras-nfes') }}">
          ...
          <!--  <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Tipo de Nota</label>
              <div class="col-sm-10">
                <select name="categoria_nota" class="form-control">
                <option value="1">Nota de Venda</option>
                <option value="2">Nota de Remessa</option>
                <option value="3">Carta de correção</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Range de data</label>
              <div class="col-sm-10">
                <input type="text" name="range_data" class="form-control drp">
              </div>
            </div>
        </div>
