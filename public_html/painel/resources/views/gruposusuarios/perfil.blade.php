...
<div class="main-content">
    <div class="m-t-n m-b" style="height:160px;">
        ...
        <div class="row profile-header text-white" style="margin-top:-280px;">
            <div class="col col-xs-2">
                <img class="profile-avatar" src="/assets/profiles/{{ Auth::user()->id }}.jpg" alt="" style="width:233px; height:233px;"  onerror="this.src='http://www.santarelli.com.br/images/no-image.jpg'; this.title='Imagem não disponível.'"/>
            ...
            <div class="col p-b-lg col-xs-10">
                ...
                <div class="profile-user" style="margin-left: 10%;">
                    <h4 class="m-t-0 m-b-0">{{ $Usuario->nome . ' ' . $Usuario->sobrenome }}</h4>                 
                </div>
            </div>
        </div>
    </div>
