...
//print_r($Model->imagens); exit;
 $Imagens = (isset($Model->imagens) && $Model->imagens)? (array) ($Model->imagens):array();
          ...
          <div class="row" style="margin-top: 25px">
            <?php foreach($Imagens as $Imagem){
                ...
                <div style="position: relative; width: 25%; float: left; margin-right: 20px;" >
                  <img data-ct="<?php echo $ct; ?>" data-id="<?php echo $imagem['id'] ?>" class="imgProd" src="<?php echo URL::to('/'); ?>/../../assets/<?php echo $imagem[$nomeCampo] ?>" style="width:100%; max-height: 150px;"/>
