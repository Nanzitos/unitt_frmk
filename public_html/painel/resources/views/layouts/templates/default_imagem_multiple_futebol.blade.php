...
//print_r($Model->imagens); exit;
 $Imagens = (isset($Model->imagens_futebol) && $Model->imagens_futebol)? (array) ($Model->imagens_futebol):array();
          ...
          <div class="row ImagensRow">
            <div class="col-sm-12">
              <div style="width:100%;" class="row" style="margin-bottom:10px;">
                <div class="col-xs-2">
                    <input type="file" name="Imagens[{{ $ct }}][imagem_futebol][]" class="form-control" multiple>
                </div>
              </div>
            </div>
          </div>
